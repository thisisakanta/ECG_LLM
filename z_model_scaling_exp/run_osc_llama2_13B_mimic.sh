...
#SBATCH --job-name=13B_m       # 作业名称
#SBATCH --account=PAS2473		    # Project ID
#SBATCH --output=/users/PAS2473/brucewan666/ECG/ECG/output_logs/13B_m_ecg.log        # 输出日志文件
#SBATCH --error=/users/PAS2473/brucewan666/ECG/ECG/output_logs/13B_m_error.log         # 错误日志文件
#SBATCH --nodes=1                   # 节点数
...
# Lora training
accelerate launch --main_process_port 31231 \
    ...
    --weight_decay 0. \
    --num_train_epochs 3 \
    --output_dir /fs/scratch/PAS2473/scaling_model_test/13B_mimic \
    --with_tracking \
