            ...
            if step > 9 and  step % args.test_step == 0:
                ...
                if accelerator.is_main_process:
                    with torch.no_grad():
                        for num_idx, batch in enumerate(tqdm(test_dataloader)):
                            ...
                            if num_idx == 5:
                                ...
                                print('reference_reports sample 2', reference_reports[0])

                                print('generate_reports sample 1', generate_reports[1])
                            ...
                            language_model_scores = compute_semantic_metric_scores(nlg_metrics, generate_reports, reference_reports, raw_datasets['test'])
                            eval_precision += language_model_scores['precision']
                            eval_recall += language_model_scores['recall']
                            eval_f1 += language_model_scores['f1']
  

                            iter_batch += 1

                    avg_precision = eval_precision / iter_batch
                    avg_recall = eval_recall / iter_batch
                    avg_f1 = eval_f1 / iter_batch
                    ...
                    if args.with_tracking:
                        accelerator.log(
                            {
                                "avg_bleu_1": avg_precision,
                                 "avg_bleu_2": avg_recall,
                                  "avg_bleu_3": avg_f1,
                    ...
                    logger.info(f"  avg_rouge_precsion: {avg_precision}, avg_recall: {avg_recall}, avg_F1: {avg_f1}")
