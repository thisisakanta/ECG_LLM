...
#SBATCH --job-name=mistral_01       # 作业名称
#SBATCH --account=PAS2473		    # Project ID
#SBATCH --output=/users/PAS2473/brucewan666/ECG/ECG/output_logs/mistral_01.log        # 输出日志文件
#SBATCH --error=/users/PAS2473/brucewan666/ECG/ECG/output_logs/mistral_01_error.log         # 错误日志文件
#SBATCH --nodes=1                   # 节点数
...
accelerate launch --main_process_port 31226 \
    ...
    --weight_decay 0. \
    --num_train_epochs 5 \
    --output_dir /fs/scratch/PAS2473/robutness_test/mistral_01 \
    --with_tracking \
