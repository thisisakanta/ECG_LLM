...
echo "Training gpt-2 model ${MODEL_SIZE} using $NUM_GPUS GPUs, $BATCH_SIZE_PER_GPU batch size per GPU, $GRADIENT_ACC_STEPS gradient accumulation steps"
    # --use_deepspeed \
...
accelerate launch --main_process_port 31226 \
    ...
    --weight_decay 0. \
    --num_train_epochs 5 \
    --output_dir /home/user/Downloads/2005047/MEIT/ECG_LLMs/save_dir_with_merl \
    --with_tracking \
