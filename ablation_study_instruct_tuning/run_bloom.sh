...
# Lora training
accelerate launch --main_process_port 31220 \
    --mixed_precision bf16 \
    --num_machines 1 \
    --num_processes $NUM_GPUS \
    /home/wan.512/ECG_LLMs/ECG_gen/finetune_ecgllm_with_lora.py \
    ...
    --weight_decay 0. \
    --num_train_epochs 5 \
    --output_dir /home/wan.512/ECG_LLMs/output_lora/bloom_exp_1 \
    --with_tracking \
