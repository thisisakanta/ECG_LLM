...
#SBATCH --job-name=gpt_j       # 作业名称
#SBATCH --account=PAS2473		    # Project ID
#SBATCH --output=/users/PAS2473/brucewan666/ECG/ECG/output_logs/gpt_j.log        # 输出日志文件
#SBATCH --error=/users/PAS2473/brucewan666/ECG/ECG/output_logs/gpt_j_error.log         # 错误日志文件
#SBATCH --nodes=1                   # 节点数
...
# Lora training
accelerate launch --main_process_port 31252 \
    ...
    --weight_decay 0. \
    --num_train_epochs 5 \
    --output_dir /fs/scratch/PAS2473/semantic_test/gpt_j_lora_ckpt_ptbxl \
    --with_tracking \
