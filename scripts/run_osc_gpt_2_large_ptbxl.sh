...
# Lora training
accelerate launch --main_process_port 31250 \
    ...
    --weight_decay 0. \
    --num_train_epochs 5 \
    --output_dir /fs/scratch/PAS2473/semantic_test/gpt_2_large_lora_ckpt_ptbxl \
    --with_tracking \
