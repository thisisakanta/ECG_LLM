...
echo "Training gpt2-large model ${MODEL_SIZE} using $NUM_GPUS GPUs, $BATCH_SIZE_PER_GPU batch size per GPU, $GRADIENT_ACC_STEPS gradient accumulation steps"
    # --use_deepspeed \
...
accelerate launch --main_process_port 31228 \
    ...
    --weight_decay 0. \
    --num_train_epochs 2 \
    --output_dir /home/user/Downloads/2005047/MEIT/ECG_LLMs/save_dir_gpt2_large \
    --with_tracking \
