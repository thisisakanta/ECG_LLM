...
#SBATCH --job-name=mistral       # 作业名称
#SBATCH --account=PAS2473		    # Project ID
#SBATCH --output=/users/PAS2473/brucewan666/ECG/ECG/output_logs/mistral_zeroshot.log        # 输出日志文件
#SBATCH --error=/users/PAS2473/brucewan666/ECG/ECG/output_logs/mistral_zeroshot_error.log         # 错误日志文件
#SBATCH --nodes=1                   # 节点数
...
accelerate launch --main_process_port 31226 \
    ...
    /users/PAS2473/brucewan666/ECG/ECG/zeroshot_test.py \
    ...
    --use_slow_tokenizer \
    --train_data_path /users/PAS2473/brucewan666/ECG/ECG/instruct_data/mimic_ecg.jsonl \
    ...
    --weight_decay 0. \
    --num_train_epochs 5 \
    --output_dir /fs/scratch/PAS2473/zershot_test_2/mistral_zeroshot \
    --with_tracking \
